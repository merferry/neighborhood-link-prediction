\begin{figure*}[hbtp]
  ...
  \caption{Impact of adjusting the hub limit $L_H$ from $2$ to $1024$ (in multiples of $2$), and to $\infty$ (\textit{IBase} approach), on the runtime (log-scale), and F1 score of predicted links (log scale), of each neighbor-based link prediction method, with the number of unobserved edges $E^U$ ranging from $10^{-4}|E|$ to $0.1|E|$. The full form of each link prediction method is given in Section \ref{sec:metrics}.}
